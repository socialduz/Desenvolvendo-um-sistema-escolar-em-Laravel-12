    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 d-flex justify-content-between align-items-end border-bottom border-secondary py-3">
                <h3 class="my-0"><span class="font-weight-bold">Professor</span> - Editar Professor</h3>
                            ...
                            <div class="form-group my-2 mb-0">
                                ...
                                <select class="form-control @error('id_usuario') is-invalid @enderror" name="id_usuario" id="id_usuario">
                                    ...
                                    @foreach ($usuarios as $usuario)
                                        <option value="{{ $usuario->id }}" @selected(old('id_usuario', $professor->id_usuario) == $usuario->id)>
                                            {{ $usuario->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group my-2 mb-0">
                                ...
                                <select class="form-control @error('id_escola') is-invalid @enderror" name="id_escola" id="id_escola">
                                    ...
                                    @foreach ($escolas as $escola)
                                        <option value="{{ $escola->id }}" @selected(old('id_escola', $professor->id_escola) == $escola->id)>
                                            {{ $escola->razao_social }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-12 col-lg-4">
                            <div class="form-group my-2 mb-0">
                                ...
                                <select class="form-control @error('status') is-invalid @enderror" name="status" id="status">
                                    <option value="1" @selected(old('status', $professor->status) == 1)>Ativo</option>
                                    <option value="0" @selected(old('status', $professor->status) == 0)>Inativo</option>
                                </select>
                                @error('status')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-12 col-lg-4">
                            <div class="form-group my-2 mb-0">
                                ...
                                <input
                                    ...
                                    name="salario"
                                    id="salario"
                                    value="{{ old('salario', $professor->salario) }}"
                                >
                                @error('salario')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-12 col-lg-4">
                            <div class="form-group my-2 mb-0">
                                ...
                                <input
                                    ...
                                    name="data_cadastro"
                                    id="data_cadastro"
                                    value="{{ old('data_cadastro', $professor->data_cadastro) }}"
                                >
                                @error('data_cadastro')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-12 col-lg-8">
                            <div class="form-group my-2 mb-0">
                                ...
                                <textarea
                                    ...
                                    id="observacao"
                                    rows="3"
                                >{{ old('observacao', $professor->observacao) }}</textarea>
                                @error('observacao')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>

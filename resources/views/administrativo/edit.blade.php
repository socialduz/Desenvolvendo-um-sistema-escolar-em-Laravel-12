    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-12 my-5">
                ...
                <form method="POST" action="{{ route('administrativo.update', $administrativo) }}">
                    @csrf
                    @method('PUT')
                            ...
                            <div class="form-group mb-0">
                                ...
                                <select class="form-control @error('id_usuario') is-invalid @enderror" name="id_usuario" id="id_usuario">
                                    ...
                                    @foreach ($usuarios as $usuario)
                                        <option value="{{ $usuario->id }}" @selected(old('id_usuario', $administrativo->id_usuario) == $usuario->id)>
                                            {{ $usuario->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group mb-0">
                                ...
                                <select class="form-control @error('id_escola') is-invalid @enderror" name="id_escola" id="id_escola">
                                    ...
                                    @foreach ($escolas as $escola)
                                        <option value="{{ $escola->id }}" @selected(old('id_escola', $administrativo->id_escola) == $escola->id)>
                                            {{ $escola->razao_social }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group mb-0">
                                ...
                                <select class="form-control @error('id_cargo') is-invalid @enderror" name="id_cargo" id="id_cargo">
                                    ...
                                    @foreach ($cargos as $cargo)
                                        <option value="{{ $cargo->id }}" @selected(old('id_cargo', $administrativo->id_cargo) == $cargo->id)>
                                            {{ $cargo->titulo }}
                                        </option>
                                    @endforeach
                                </select>

-- =====================================================================
-- Script de criação de tabelas - PostgreSQL
-- Convertido do script MySQL original.
-- Principais ajustes:
--   * "int ... auto_increment" -> "serial" (auto-incremento nativo)
--   * removido "not null" redundante da PRIMARY KEY (implícito)
--   * tipos, defaults e foreign keys mantidos (compatíveis)
-- =====================================================================
